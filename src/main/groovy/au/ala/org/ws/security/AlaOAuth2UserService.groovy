...
public class AlaOAuth2UserService extends OidcUserService {
    ...
    public OidcUser loadUser(OidcUserRequest userRequest) throws OAuth2AuthenticationException {
        ...
        if (this.shouldRetrieveUserInfo(userRequest)) {
            ...
            userInfo = new OidcUserInfo(attributes);
...
//                new OidcUserAuthority(userRequest.getIdToken(), userInfo));
        ...
        Set<GrantedAuthority> authorities = authoritiesUserInfo.asList()
                .stream().map { new SimpleGrantedAuthority(it) }.collect(Collectors.toSet());
