...
//        config.addCustomParam("prompt", "none");
    ...
    @Bean
    @Primary
    OidcClient oidcClient(@Qualifier('oidcConfiguration') OidcConfiguration oidcConfiguration, CookieGenerator authCookieGenerator, StatePoolStore statePoolStore) {
